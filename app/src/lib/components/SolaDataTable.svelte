          ...
          <tr>
            ...
            {#each columns as col}
              <th
                ...
                class="px-4 {compact ? 'py-2.5' : 'py-3.5'} text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 {col.sortable !== false ? 'cursor-pointer hover:text-slate-900 dark:hover:text-white transition-colors' : ''}"
