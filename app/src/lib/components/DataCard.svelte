...
<div class="group relative bg-white/90 dark:bg-white/[0.02] border border-slate-200/80 dark:border-white/[0.04] rounded-3xl p-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_-6px_rgba(14,165,233,0.12)] hover:border-sky-300 dark:border-sky-500/30/80 transition-all duration-200 overflow-hidden">
  ...
  {#if config.trend}
    <div class="flex items-center gap-2 pt-1 border-t border-slate-100 dark:border-white/[0.04] relative z-10">
      <div class="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-semibold font-mono {isPositive ? 'bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-500/20/60' : 'bg-rose-50 dark:bg-rose-500/10 text-rose-700 dark:text-rose-400 border border-rose-200 dark:border-rose-500/20/60'}">
        {#if isPositive}
