...
- Location: e2e\site-audit.spec.ts:86:7
...
Expected pattern: /Speak or type intent/
Received string:  "Command Sola... (e.g. 'Show enterprise MRR and churn rate')"
Timeout: 5000ms

Call log:
  - Expect "toHaveAttribute" with timeout 5000ms
  - waiting for locator('input[type="text"]')
    14 × locator resolved to <input value="" type="text" placeholder="Command Sola... (e.g. 'Show enterprise MRR and churn rate')" class="flex-1 bg-transparent py-4 px-2 text-slate-900 text-base font-medium focus:outline-none placeholder-slate-400"/>
       - unexpected value "Command Sola... (e.g. 'Show enterprise MRR and churn rate')"

```

```yaml
- textbox "Command Sola... (e.g. 'Show enterprise MRR and churn rate')"
```
