...
Call log:
  ...
  - waiting for locator('input[type="text"]')
    14 × locator resolved to <input type="text" placeholder="Command Sola... (e.g. 'Show enterprise MRR and churn rate')" class="flex-1 bg-transparent py-4 px-2 text-slate-900 text-base font-medium focus:outline-none placeholder-slate-400"/>
