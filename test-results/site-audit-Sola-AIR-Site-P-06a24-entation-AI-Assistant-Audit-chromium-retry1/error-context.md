...
- Name: site-audit.spec.ts >> Sola AIR Site & Product Audit >> Interactive Documentation & AI Assistant Audit
- Location: e2e\site-audit.spec.ts:64:7
...
Locator: locator('h2')
Expected substring: "Documentation that explains itself."
Timeout: 5000ms
